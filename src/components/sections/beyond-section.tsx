            ...
            <div className={`beyond-subsection-1`}>
              <div className="max-w-4xl mx-auto text-container">
                ...
                <div className="clearfix">
                  <div className="photo-container group float-right w-48 h-48 ml-8 mb-6 rounded-xl overflow-hidden relative cursor-pointer border border-primary/20">
                    {sections[1].image ? (
                      <img 
                        src={sections[1].image} 
                        alt={sections[1].title}
                        className="parallax-photo w-full h-full object-cover grayscale transition-all duration-700 group-hover:grayscale-0"
                      />
                    ) : (
