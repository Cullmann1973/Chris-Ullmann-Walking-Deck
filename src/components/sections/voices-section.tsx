              ...
              <div className="group h-full rounded-xl border border-white/10 bg-dark/80 p-6 transition-all duration-500 hover:scale-[1.25] hover:z-50 hover:border-primary/25 hover:shadow-[0_20px_60px_rgba(0,188,212,0.12)] origin-center">
                ...
                <div className="flex items-start justify-between mb-5">
                  <div className="flex items-center gap-3">
                    ...
                    <div
                      className={`w-12 h-12 rounded-full flex-shrink-0 overflow-hidden ring-[3px] ring-white shadow-[0_0_0_1.5px_rgba(0,0,0,0.8),0_0_0_4px_rgba(255,255,255,0.9)] ${!voice.photo ? `bg-gradient-to-br ${voice.gradient} flex items-center justify-center` : ""}`}
                    >
                      {voice.photo ? (
                        <img
                          src={voice.photo}
