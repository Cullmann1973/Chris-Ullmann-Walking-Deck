              ...
              <div className="group h-full rounded-xl border border-white/10 bg-dark/80 p-6 transition-all duration-500 hover:scale-[1.25] hover:z-50 hover:border-primary/25 hover:shadow-[0_20px_60px_rgba(0,188,212,0.12)] origin-center">
                ...
                <div className="flex items-start justify-between mb-5">
                  <div className="flex items-center gap-3">
                    ...
                    <div
                      className={`w-12 h-12 rounded-full flex-shrink-0 overflow-hidden ring-[2px] ring-white/70 shadow-[0_0_0_1px_rgba(0,0,0,0.6),0_0_0_3px_rgba(255,255,255,0.65)] ${!voice.photo ? `bg-gradient-to-br ${voice.gradient} flex items-center justify-center` : ""}`}
                    >
                      {voice.photo ? (
                        <img
                          src={voice.photo}
