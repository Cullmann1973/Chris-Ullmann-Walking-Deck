...
## The Key Differentiator: "The Translator"

Leaders at Microsoft, Engineering, and senior business leaders have told me I have a rare skill as a translator between business and technology. Most people are either:
- Technical but cannot communicate with business stakeholders
...
1. Identify the desired state (what does "done" look like?)
2. Analyze current variables (people, process, technology, constraints)
3. Construct the most efficient path to optimization
...
- Leading AI adoption in Manufacturing (ownership), with significant influence across Supply Chain, Marketing, R&D, and Engineering
...
- Leading Bold Change (Kotter) certified facilitator; drove employee-led savings generating several million dollars and improved morale
- The Coty transformation was featured in Harvard Business Review: "How Coty Reinvigorated Its Supply Chain" (May 2016)
...
- These baseline improvements established the credibility and operational maturity that made senior leadership trust my team with the consolidation
...
- Reduced quarantine inventory from $16M to under $200K across 5 U.S. plants
- Managed distressed inventory recovery across the entire plant network
...
## Core Philosophy
- "The Builder": every challenge is an engineering problem with a desired state, current variables, and an optimal path
- "The Translator": bridges strategy and operations, tech and business, executive vision and shop-floor reality
- "People first" approach to leadership
- Kotter's 8-Step Change Model as the transformation framework, applied consistently across career
- AI is a force multiplier for human expertise, not a replacement
